              ...
              <form action="proses/pe_anggota.php" method="POST" enctype="multipart/form-data">
				  ...
				  <tr>
					<td>No KTP</td>
                      <td>:</td>
                      <td>
						<input type="text" name="no_ktp" value="<?php echo $num["no_ktp"]; ?>" />
					  </td>
				  </tr>
				  <tr>
					<td>Nama Lengkap</td>
				  ...
				  <tr>
					<td>Alamat</td>
                      <td>:</td>
                      <td>
						<input type="text" name="alamat" value="<?php echo $num["no_ktp"]; ?>" />
					  </td>
				  </tr>
				  <tr>
                      <td>Foto</td>
				  ...
				  <tr>
					<td>Username</td>
                      <td>:</td>
                      <td>
						<input type="text" name="username" value="<?php echo $num["username"]; ?>" />
					  </td>
				  </tr>
				  <tr>
					<td>Password</td>
...
"></i> Sorting Data</a> 
              ...
              <table class="table table-striped table-bordered">
				...
				if($_POST['tipecari'] == "nama_lengkap"){
					$sql = mysql_query("SELECT * FROM tbl_anggota WHERE nama_lengkap LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "username"){
					$sql = mysql_query("SELECT * FROM tbl_anggota WHERE username LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "email"){
					$sql = mysql_query("SELECT * FROM tbl_anggota WHERE email LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "status_jabatan"){
					$sql = mysql_query("SELECT * FROM tbl_anggota WHERE status_jabatan LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}
