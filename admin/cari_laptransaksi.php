...
<form style="margin:0px;" method="POST" action="cari_laptransaksi.php">
              ...
              <form action="proses/pe_lap_transaksi.php" method="POST">
				  ...
				  <tr>
					<td>Metode Pembyaran</td>
                      <td>:</td>
					<td><input type="text" class="form-control" name="metode_pembayaran" value="<?php echo $num['metode_pembayaran']; ?>" /></td>
				  </tr>
				  <tr>
					<td>Atas Nama</td>
                      <td>:</td>
			...
			<div class="alert alert-success">
			  ...
			  <form action="report_transaksi.php" method="POST" target="_blank">
				<?php
...
"></i> Sorting Data</a>
              ...
              <table class="table table-striped table-bordered">
				...
				if($_POST['tipecari'] == "nama_lengkap"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_anggota.nama_lengkap LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "tanggal"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.tgl_daftar LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "waktu"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.waktu_daftar LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "metode_pembayaran"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.metode_pembayaran LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "atas_nama"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.atas_nama LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "jumlah_bayar"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.jumlah_bayar LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "status_bayar"){
					$sql = mysql_query("SELECT * FROM tbl_transaksi_pembayaran, tbl_anggota WHERE tbl_anggota.no_ktp = tbl_transaksi_pembayaran.no_ktp AND tbl_transaksi_pembayaran.status_bayar LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}
