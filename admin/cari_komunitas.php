...
"></i> Sorting Data</a>
              ...
              <table class="table table-striped table-bordered">
				...
				if($_POST['tipecari'] == "nama_komunitas"){
					$sql = mysql_query("SELECT * FROM tbl_komunitas, tbl_jenjang, tbl_kategori_komunitas WHERE tbl_komunitas.id_jenjang = tbl_jenjang.id_jenjang AND tbl_komunitas.id_kategori_k = tbl_kategori_komunitas.id_kategori_k AND nama LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "jenjang"){
					$sql = mysql_query("SELECT * FROM tbl_komunitas, tbl_jenjang, tbl_kategori_komunitas WHERE tbl_komunitas.id_jenjang = tbl_jenjang.id_jenjang AND tbl_komunitas.id_kategori_k = tbl_kategori_komunitas.id_kategori_k AND jenjang LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}else if($_POST['tipecari'] == "kategori"){
					$sql = mysql_query("SELECT * FROM tbl_komunitas, tbl_jenjang, tbl_kategori_komunitas WHERE tbl_komunitas.id_jenjang = tbl_jenjang.id_jenjang AND tbl_komunitas.id_kategori_k = tbl_kategori_komunitas.id_kategori_k AND jenis_kategori LIKE '%$data%' ORDER BY $orderBy $statusbaru");
				}
